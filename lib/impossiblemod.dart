...
class Impossible extends StatefulWidget {
  @override
  bool val;
  Impossible({this.val});
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _impossible(val: val);
  }
}

class _impossible extends State<Impossible> {
  @override
  bool val;

  _impossible({this.val});
  AudioCache player;
  void initState() {
    super.initState();
    player = AudioCache(
  ...
  aimove() {
    ...
    var move = MiniMaxAI().bestMove(twod);
    print(move);
